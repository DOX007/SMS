...
class NewConversationActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Visa inte SEND-knappen om den är inaktiverad i inställningar
        binding.newConversationConfirm.beVisibleIf(!config.disableSendButton)
    ...
    private fun initContacts() {
        ...
        binding.newConversationAddress.onTextChangeListener { searchString ->
            ...
            binding.newConversationConfirm.beVisibleIf(searchString.length > 2 && !config.disableSendButton)
