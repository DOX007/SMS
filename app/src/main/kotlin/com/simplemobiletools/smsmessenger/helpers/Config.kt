...
class Config(context: Context) : BaseConfig(context) {
    companion object {
        ...
        private const val DISABLE_SEND_BUTTON = "disable_send_button"
    }
    ...
    var disableSendButton: Boolean
        get() = prefs.getBoolean(DISABLE_SEND_BUTTON, false)
        set(value) = prefs.edit().putBoolean(DISABLE_SEND_BUTTON, value).apply()
