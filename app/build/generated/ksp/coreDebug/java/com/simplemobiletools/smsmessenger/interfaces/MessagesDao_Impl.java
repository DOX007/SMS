...
public final class MessagesDao_Impl implements MessagesDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteMessagesFromAddress;
  ...
  public MessagesDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__preparedStmtOfDeleteMessagesFromAddress = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM messages WHERE sender_phone_number = ? OR participants LIKE '%' || ? || '%'";
        return _query;
      }
    };
  }
  ...
  @Override
  public void deleteMessagesFromAddress(final String number) {
    __db.assertNotSuspendingTransaction();
    final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteMessagesFromAddress.acquire();
    int _argIndex = 1;
    ...
    try {
      ...
      __preparedStmtOfDeleteMessagesFromAddress.release(_stmt);
    }
  }
